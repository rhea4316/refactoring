...
public class StatementPrinter {
    ...
    public String statement() {
        ...
        for (Performance performance : invoice.getPerformances()) {
            ...
            // add volume credits
            final int initial = 0;
            volumeCredits += getVolumeCredits(performance, initial);
    ...
    private static String usd(int originalAmount) {
        return NumberFormat.getCurrencyInstance(Locale.US).format(originalAmount / Constants.PERCENT_FACTOR);
    }

    private int getVolumeCredits(Performance performance, int initial) {
        int result = initial;
